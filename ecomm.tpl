...
<!--   Create the Product Navigation Index here
  ==========================================================================-->
  <table width=100%><tr><td valign=top width=5%><img src="o_2.png"></td><td class=b><a href="index.html">ComputoGT</a><table class=mb width=100%><tr><td valign=top width=5%><img src="f_2.png"></td><td class=m><a href="laptops.htm">Laptops</a></td></tr>
<tr><td valign=top width=5%><img src="f_2.png"></td><td class=m><a href="desktops2.htm">Desktops</a></td></tr>
<tr><td valign=top width=5%><img src="f_2.png"></td><td class=m><a href="accesorios2.htm">Accesorios</a></td></tr>
</table></td></tr>
